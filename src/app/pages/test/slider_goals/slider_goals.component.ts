...
@Component({
  ...
  templateUrl: './slider_goals.component.html',
  styleUrls: ['./slider_goals.component.scss', './slider_goals-mobile.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SliderGoalsComponent {
  ...
  constructor() {
    this.percent.setValue(this.testService.test().goals);
  }
  ...
  nexStep(){
    this.testService.test.update(value => ({...value, goals: this.percent.value }));
